...
<<<<<<< HEAD
                ...
                className="bg-red-950/80 hover:bg-red-900 text-red-200 text-xs font-medium px-2 sm:px-3 py-1.5 rounded-lg border border-red-800 flex items-center gap-1 transition-colors shrink-0 cursor-pointer"
                title="Clear all appointment history ready for live deployment"
              >
                <Trash2 className="w-3.5 h-3.5 text-red-400" />
                <span>Clear All (Live Reset)</span>
              </button>
...
<<<<<<< HEAD
                      {!isCompleted && !isCancelled && (
                        <button
                          type="button"
                          onClick={() => handleSetClinicalStatus(appt.id, 'completed')}
